...
public class OpinetClient
{
    ...
    public OpinetClient(HttpClient http, IConfiguration config)
    {
        _http = http;
    ...
    public Task<OpinetEnvelope<SidoPriceItem>> GetAvgSidoPriceAsync(
        string? sido = null, string? prodcd = null, CancellationToken ct = default)
    ...
    // 편의 메서드: 시군구별 평균가
    public Task<OpinetEnvelope<SigunPriceItem>> GetAvgSigunPriceAsync(
        string sido, string? sigun = null, string? prodcd = null, CancellationToken ct = default)
    ...
    public Task<OpinetEnvelope<AvgRecentPriceItem>> GetAvgRecentPriceAsync(
        string? date = null, string? prodcd = null, CancellationToken ct = default)
    ...
    public Task<OpinetEnvelope<PollAvgRecentPriceItem>> GetPollAvgRecentPriceAsync(
        string? prodcd = null, string? pollcd = null, CancellationToken ct = default)
    ...
    public Task<OpinetEnvelope<AreaAvgRecentPriceItem>> GetAreaAvgRecentPriceAsync(
        string area, string? date = null, string? prodcd = null, CancellationToken ct = default)
    ...
    // 편의 메서드: 최근 1주 주간 평균가
    public Task<OpinetEnvelope<AvgLastWeekItem>> GetAvgLastWeekAsync(
        string? prodcd = null, string? sido = null, CancellationToken ct = default)
    ...
    public Task<OpinetEnvelope<LowTopItem>> GetLowTopAsync(
        string prodcd, string? area = null, int? cnt = null, CancellationToken ct = default)
    ...
    // 편의 메서드: 반경 내 검색
    public Task<OpinetEnvelope<AroundAllItem>> GetAroundAllAsync(
        double x, double y, int radiusMeters, string prodcd, int sort = 1, CancellationToken ct = default)
    ...
    // 편의 메서드: 상세정보(ID)
    public Task<OpinetEnvelope<DetailByIdItem>> GetDetailByIdAsync(
    ...
    // 편의 메서드: 상호 검색
    public Task<OpinetEnvelope<SearchByNameItem>> SearchByNameAsync
        (string osnm, string? area = null, CancellationToken ct = default)
    ...
    // 편의 메서드: 요소수 가격(지역별)
    public Task<OpinetEnvelope<UreaPriceItem>> GetUreaPriceAsync(
        string area, CancellationToken ct = default)
    ...
    // 편의 메서드: 지역코드 조회
    public Task<OpinetEnvelope<AreaCodeItem>> GetAreaCodeAsync(
        string? area = null, CancellationToken ct = default)
